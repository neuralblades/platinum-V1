    ...
    <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-white">Platinum Square</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/properties?type=apartment" className="text-gray-300 hover:text-white transition duration-300">
                  Apartments
                </Link>
              </li>
              <li>
                <Link href="/properties?type=villa" className="text-gray-300 hover:text-white transition duration-300">
                  Villas
                </Link>
              </li>
              <li>
                <Link href="/properties?type=penthouse" className="text-gray-300 hover:text-white transition duration-300">
                  Penthouses
                </Link>
              </li>
              <li>
                <Link href="/properties?type=commercial" className="text-gray-300 hover:text-white transition duration-300">
                  Commercial
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                ...
                <span>2902 Concord Tower, Media City, Dubai</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span>info@platinumsquare.ae</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-300">
          <p>&copy; {currentYear} Platinum Square Real Estate. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
