        ...
        <div className="animate-fade-in-up">
          <div className="rounded-lg bg-gray-100 p-6 text-center text-gray-800">
            ...
            <div className="mt-4">
              <Link 
                href="/blog"
                className="inline-block rounded-md bg-gradient-to-r from-gray-600 to-gray-800 px-4 py-2 text-white transition-all hover:from-gray-700 hover:to-gray-900"
              >
                Back to Blog
              </Link>
            </div>
            ...
            <div className="mt-8 rounded-xl bg-white p-8 shadow-md">
              ...
              {isAuthenticated ? (
                ...
                <div className="mb-8 rounded-md bg-gray-50 p-4 text-gray-800">
                  <p>
                    Please{' '}
                    <Link href="/auth/login" className="font-medium text-gray-600 underline">
                      log in
                    </Link>{' '}
                    to leave a comment.
                  </p>
